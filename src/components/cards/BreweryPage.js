  ...
  return (
    <>
      ...
      <Container>
                    ...
                    <Steps>
                      ...
                      <Step>
                        ...
                        >
                          ...
                          <StepDescription>
                            {getFormattedPhoneNumber(brewery.phone)}
                          </StepDescription>
                        </StepText>
                      </Step>
                    </Steps>
                    ...
                    <Steps>
                      <Step>
                        ...
                        >
                          ...
                          <StepDescription>
                            {brewery.website_url ? brewery.website_url : "NA"}
                          </StepDescription>
                        </StepText>
                      </Step>
                      <Step>
                ...
                {userContext.token != null && (
                  <Statistics>
                    ...
                    <Statistic>
                      ...
                      />
                      <Value>
                        {(breweryStats && breweryStats.dislikes) || 0}
                      </Value>
                      <Key>Disikes</Key>
                    </Statistic>
                    <Statistic>
                      ...
                      />
                      <Value>
                        {(breweryStats && breweryStats.visits) || 0}
                      </Value>
                      <Key>Visits</Key>
                    </Statistic>
                    <Statistic>
                      <ReviewsIcon color="purple" width="42" height="42" />
                      <Value>
                        {(breweryStats && breweryStats.reviewsCount) || 0}
                      </Value>
                      <Key>Reviews</Key>
                    </Statistic>
                  </Statistics>
        ...
        <ReviewsCard bid={bid} userRole={userRole} />
